...
export type IconVariant = 'braces' | 'function' | 'code' | 'box' | 'variable' | 'brackets' | 'regex' | 'square-code' | 'terminal' | 'signpost' | 'layout-list' |
    ...
    'book-check' | 'play' | 'list-x' | 'list-checks' | 'list-todo' | 'mail' | 'plus' | 'trash' | 'calendar-clock' | 'calendar-x-2' | 'link' | 'link-2' | 'link-2-off' | 'external-link' |
    'file-plus' | 'file-x' | 'file-pen' | 'file-key'
