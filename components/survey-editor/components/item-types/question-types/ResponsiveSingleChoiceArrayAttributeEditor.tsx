...
interface ResponsiveSingleChoiceArrayAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const ResponsiveSingleChoiceArrayAttributeEditor: React.FC<ResponsiveSingleChoiceArrayAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        <p className='font-bold py-2 my-2'>
            ...
            Responsive single choice array
        </p>
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'rsca', role: 'responsiveSingleChoiceArray' }}
...
export default ResponsiveSingleChoiceArrayAttributeEditor;
