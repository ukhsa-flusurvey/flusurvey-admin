...
interface MultilineTextinputAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const MultilineTextinputAttributeEditor: React.FC<MultilineTextinputAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        ...
        <GenericQuestionPropEditor
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'ic', role: 'multilineText' }}
            ...
            onChange={(newProps) => {
                const newItem = SurveyItems.textInput({
                    ...newProps,
                }) as SurveySingleItem;
...
export default MultilineTextinputAttributeEditor;
