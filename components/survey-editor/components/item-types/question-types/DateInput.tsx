...
interface DateInputAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const DateInputAttributeEditor: React.FC<DateInputAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        ...
        <GenericQuestionPropEditor
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'date', role: 'dateInput', items: [] }}
            ...
            onChange={(newProps) => {
                const newItem = SurveyItems.dateInput({
                    ...newProps,
                    dateInputMode: 'YM',
                }) as SurveySingleItem;
...
export default DateInputAttributeEditor;
