...
interface ConsentAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const ConsentAttributeEditor: React.FC<ConsentAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        ...
        <GenericQuestionPropEditor
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'con', role: 'consent', items: [] }}
            ...
            onChange={(newProps) => {
                const newItem = SurveyItems.consent({
                    ...newProps,
                    acceptBtn: new Map(),
...
export default ConsentAttributeEditor;
