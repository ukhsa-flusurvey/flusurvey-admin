...
interface SliderNumericAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const SliderNumericAttributeEditor: React.FC<SliderNumericAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        ...
        <GenericQuestionPropEditor
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'slider', role: 'sliderNumeric', items: [] }}
            ...
            onChange={(newProps) => {
                const newItem = SurveyItems.numericSlider({
                    ...newProps,
...
export default SliderNumericAttributeEditor;
