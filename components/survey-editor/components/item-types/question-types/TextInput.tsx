...
interface TextInputAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const TextInputAttributeEditor: React.FC<TextInputAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'ic', role: 'input' }}
...
export default TextInputAttributeEditor;
