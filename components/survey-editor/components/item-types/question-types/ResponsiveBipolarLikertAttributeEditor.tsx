...
interface ResponsiveBipolarLikertScaleArrayAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const ResponsiveBipolarLikertScaleArrayAttributeEditor: React.FC<ResponsiveBipolarLikertScaleArrayAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
    ...
    return (<>
        <p className='font-bold py-2 my-2'>
            ...
            Responsive bipolar likert scale array
        </p>
        <GenericQuestionPropEditor
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'rsbla', role: 'responsiveBipolarLikertScaleArray' }}
            ...
            onChange={(newProps) => {
                const newItem = SurveyItems.numericInput({
                    ...newProps,
                    inputLabel: new Map(),
                }) as SurveySingleItem;
...
export default ResponsiveBipolarLikertScaleArrayAttributeEditor;
