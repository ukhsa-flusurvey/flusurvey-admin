...
interface ResponsiveMatrixAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const ResponsiveMatrixAttributeEditor: React.FC<ResponsiveMatrixAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'rm', role: 'responsiveMatrix' }}
...
export default ResponsiveMatrixAttributeEditor;
