...
interface DropdownGroupAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const DropdownGroupAttributeEditor: React.FC<DropdownGroupAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'ddg', role: 'dropDownGroup', items: [] }}
...
export default DropdownGroupAttributeEditor;
