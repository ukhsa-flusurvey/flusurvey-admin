...
interface NumericInputAttributeEditorProps {
    surveyItem: SurveySingleItem;
    onItemChange: (item: SurveySingleItem) => void;
}


const NumericInputAttributeEditor: React.FC<NumericInputAttributeEditorProps> = ({
    surveyItem,
    onItemChange,
}) => {
            ...
            specificEditGroup={
                {
                    ...
                    content: (
                        <MonacoResponseGroupContentEditor
                            itemComponent={mainResponseSlot ? { ...(mainResponseSlot as ItemGroupComponent).items[0] } : { key: 'num', role: 'numberInput' }}
...
export default NumericInputAttributeEditor;
